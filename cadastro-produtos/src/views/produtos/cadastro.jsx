...
//#region crud cadastro com bootstrap
const estadoInicial = {
    nome: '' ,
    sku: '',
    descricao: '',
            ...
            <Card header={this.state.atualizando ? 'Atualização de Produto ' : 'Cadastro de Produto '} >
                {/* <div className="card-header">
                    ...
                    {/* <div className="card-body"> */}
                        ...
                        <strong>Legal!</strong> Cadastro realizado com sucesso!
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                             <div className="form-group">
                                  <label>SKU: *</label>  
                                  <input type="text"  name="sku" disabled={this.state.atualizando}
                                   onChange={this.onChange} value={this.state.sku} className="form-control" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                  ...
                                  onChange={this.onChange}name="preco" type="text" className="form-control" />
                                      </div>
                                  </div>
